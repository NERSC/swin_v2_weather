...
#reference: https://github.com/NVIDIA/modulus/blob/main/modulus/models/sfno/sfnonet.py copied on 10/29/23
...
class SphericalFourierNeuralOperatorNet(Module):
    ...
    def __init__(
        ...
        self.in_chans = (
            ...
            params.N_in_channels + (1 if params.add_zenith else 0) if hasattr(params, "N_out_channels") else in_chans
        )
        self.out_chans = (
            # params.N_out_channels + (1 if params.add_zenith else 0) if hasattr(params, "N_out_channels") else out_chans
