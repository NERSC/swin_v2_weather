...
config="afno_backbone_26var_lamb_embed1536_dpr03_dr01_scale2_dt4_decode"
run_num="intr"
cmd="python train_check.py --enable_amp --yaml_config=$config_file --config=$config --run_num=$run_num"
